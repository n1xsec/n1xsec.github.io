...
async function get(url) {
  try {
    ...
    console.log(`GET request to ${url} - Status: ${response.status}`);
  } catch (error) {
    console.error(`GET request to ${url} failed - Error: ${error}`);
  }
}
...
async function post(url, params) {
  try {
    ...
    console.log(`POST request to ${url} - Status: ${response.status}`);
  } catch (error) {
    console.error(`POST request to ${url} failed - Error: ${error}`);
  }
}
